...
namespace DeveloperStartMenu.VoiceCommands
{
    ...
    /// DeveloperStartMenuCommands.xml VCD file in the DeveloperStartMenu project. The service
    /// entrypoint is defined in the Package Manifest (See section uap:Extension in 
    /// DeveloperStartMenu:Package.appxmanifest)
    /// </summary>
    public sealed class DeveloperStartMenuVoiceCommandService : IBackgroundTask
    {
        /// <summary>
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            if (triggerDetails != null && triggerDetails.Name == "DeveloperStartMenuVoiceCommandService")
            {
                try
                {
                    ...
                    // Depending on the operation (defined in DeveloperStartMenu:DeveloperStartMenuCommands.xml)
        ...
        private async Task<Model.Trip> DisambiguateTrips(IEnumerable<Model.Trip> trips, string disambiguationMessage, string secondDisambiguationMessage)
        {
            ...
            foreach (Model.Trip trip in trips)
            {
                ...
                destinationTile.Image = await StorageFile.GetFileFromApplicationUriAsync(new Uri("ms-appx:///DeveloperStartMenu.VoiceCommands/Images/GreyTile.png"));
        ...
        {
            var userMessage = new VoiceCommandUserMessage();
            userMessage.SpokenMessage = cortanaResourceMap.GetValue("LaunchingDeveloperStartMenu", cortanaContext).ValueAsString;
