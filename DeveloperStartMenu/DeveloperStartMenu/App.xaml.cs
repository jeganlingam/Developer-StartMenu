...
using DeveloperStartMenu.Common;
    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            try
            {
                ...
                StorageFile vcdStorageFile = await Package.Current.InstalledLocation.GetFileAsync(@"DeveloperStartMenuCommands.xml");
        ...
        protected async override void OnActivated(IActivatedEventArgs args)
        {
            ...
            if (args.Kind == ActivationKind.VoiceCommand)
            {
                ...
                // Get the name of the voice command and the text spoken. See DeveloperStartMenuCommands.xml for
