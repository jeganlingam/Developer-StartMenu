...
namespace DeveloperStartMenu.ViewModel
{
    /// <summary>
    /// Simple struct to pass voice-command arguments to the appropriate view, in order to execute the 
    /// action requested by the user. Reference OnActivated() in App.xaml.cs, and DeveloperStartMenuCommands.xml
    ...
    public struct TripVoiceCommand
    {
        ...
        /// Oriented around the "showTripToDestination" VCD command (See DeveloperStartMenuCommands.xml)
        /// </summary>
